...
*******************************************************************************/
/* RTOS related macros. */
#define NETWORK_ACTIVITY_TASK_STACK_SIZE  (1024U * 5U)
#define NETWORK_ACTIVITY_TASK_PRIORITY    (1U)
...
int main(void)
{
    ...
    /* Create the tasks. */
    result = xTaskCreate(network_idle_task, "Network task", NETWORK_ACTIVITY_TASK_STACK_SIZE, NULL,
                NETWORK_ACTIVITY_TASK_PRIORITY, NULL);
