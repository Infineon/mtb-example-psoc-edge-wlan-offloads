...
The following example clones the "[WlanOffloads application](https://github.com/Infineon/mtb-example-psoc-edge-wlan-offloads)" application with the desired name "WlanOffloads" configured for the *KIT_PSE84_EVAL_EPC2* BSP into the specified working directory, *C:/mtb_projects*:

   ```
   project-creator-cli --board-id KIT_PSE84_EVAL_EPC2 --app-id mtb-example-psoc-edge-wlan-offloads --user-app-name WlanOffloads --target-dir "C:/mtb_projects"
   ```
